# Generated by Django 3.2.6 on 2021-08-13 17:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='creatorplatform.category', verbose_name='Category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateField(auto_now=True)),
                ('image', models.ImageField(upload_to='uploads/images', verbose_name='Image')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='category', to='creatorplatform.category', verbose_name='Category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='creatorplatform.review', verbose_name='Parent')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='creatorplatform.product', verbose_name='Product')),
                ('review_on_store', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='creatorplatform.store', verbose_name='Parent')),
            ],
            options={
                'verbose_name': 'Review',
        ...
        migrations.AddField(
            model_name='product',
            name='stores',
            field=models.ManyToManyField(to='creatorplatform.Store', verbose_name='Stores'),
        ),
    ]
